      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-2 bg-white border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 text-gray-900"
            />
          </div>
          <div>
        ...
        <div className="mb-4">
          ...
          {formData.requirements.map((req, index) => (
            <div key={index} className="flex items-center mb-2">
              <input
                ...
                required
                className="flex-grow px-4 py-2 bg-white border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 text-gray-900"
          ...
          <button
            ...
            className="flex items-center text-blue-900 hover:text-cyan-300 transition-colors mt-2"
          >
        ...
        <button
          ...
          className="w-full bg-blue-900 text-gray-900 px-6 py-3 rounded-md font-semibold hover:bg-cyan-400 transition-colors flex items-center justify-center disabled:opacity-70"
        >
